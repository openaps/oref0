...
do 
    ...
    echo "oref0-autotune-core autotune.$i.json profile.json profile.pump.json | jq . -M > newprofile.$i.json"
    if ! oref0-autotune-core autotune.$i.json profile.json profile.pump.json | jq . -M > newprofile.$i.json; then

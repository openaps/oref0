...
if (!module.parent) {
  var argv = require('yargs')
    .usage("$0 pumphistory-zoned.json profile.json clock-zoned.json glucose.json basalprofile.json [carbhistory.json] [--prepared]")
    .option('prepared', {
      alias: 'p',
  ...
  var glucose_input = argv._.slice(3, 4).pop();
  var basalprofile_input = argv._.slice(4, 5).pop();
  var carb_input = argv._.slice(5, 6).pop()
  ...
  var generate = (argv.prepared) ? require('oref0/lib/meal-prepared') : require('oref0/lib/meal');

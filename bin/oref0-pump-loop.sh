...
function compare_with_fullhistory() {
  ...
  && ((( pumphistory -a 2>&3 | jq -f openaps.jq 2>&3 | tee monitor/full-pumphistory-24h-zoned.json 2>&3 >&4 ) \
      && echo -n ed) \
...
function read_full_pumphistory() {
  ...
  && ((( pumphistory -a 2>&3 | jq -f openaps.jq 2>&3 | tee monitor/pumphistory-24h-zoned.json 2>&3 >&4 ) \
      && echo -n ed) \
     || (
        echo " failed. "
        rm monitor/pumphistory-24h-zoned.json

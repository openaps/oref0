...
if (!module.parent) {
    ...
    var argv = require('yargs')
      .usage("$0 profile.json NSURL api-secret")
...
/*    console.log('------------- NEW PROFILE');
    ...
    console.log("Profiles are still equal",_.isEqual(original_profile, new_profile));
*/
    if (!_.isEqual(original_profile, new_profile)) {
        
        // Upload to NS
        
        var upload_profile = new_profile;
        ...
        console.log('Profile for upload',upload_profile);

...
function tuneAllTheThings (inputs) {
    ...
    if (typeof(pumpISF) !== 'undefined') {
        ...
        if (newISF > maxISF) {
            console.error("Limiting ISF to",maxISF.toFixed(2),"(which is",autotuneMin"* pump ISF of",pumpISF,")");
            newISF = maxISF;
        } else if (newISF < minISF) {
            console.error("Limiting ISF to",minISF.toFixed(2),"(which is",autotuneMax"* pump ISF of",pumpISF,")");
            newISF = minISF;
        }
    }
    ...
    if (typeof(pumpCSF) !== 'undefined') {
        ...
        if (newCSF > maxCSF) {
            console.error("Limiting CSF to",maxCSF.toFixed(2),"(which is",autotuneMin"* pump CSF of",pumpCSF,")");
            newCSF = maxCSF;

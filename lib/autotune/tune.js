...
function tuneAllTheThings(opts, time) {
    ...
    for (var i=bucketed_data.length-4; i > 0; --i) {
        ...
        console.error(absorbing.toString(),"MealCOB:",mealCOB.toFixed(1),"basal BGI:",basalBgi.toFixed(1),"BGI:",bgi.toFixed(1),"at",bgDate, "Dev:",deviation,"avgDelta:",avgDelta,type);
    }

...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    calcreason = "BG-accel: " + bg_acceleration + ", PF-min: " + parabola_fit_minutes + ", PF-corr: " + parabola_fit_correlation + ", PF-nDelta: " + parabola_fit_next_delta + ", PF-lDelta: " + parabola_fit_last_delta +  ", regDelta: " + glucose_status.delta + ", ";
...
// Print summary variables based on predBGs etc.
    ...
    rT.reason= calcreason + isfreason + "minPredBG " + convert_bg(minPredBG, profile) + ", minGuardBG " + convert_bg(minGuardBG, profile) + ", IOBpredBG " + convert_bg(lastIOBpredBG, profile);
    if (lastCOBpredBG > 0) {

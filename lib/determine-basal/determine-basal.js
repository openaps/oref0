...
// start autoISF, relevant variables and functions
...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    var slope05 = glucose_status.slope05;
    var slope15 = glucose_status.slope15;
    var slope40 = glucose_status.slope40;
    ...
    calcreason += "BG-accel: " + bg_acceleration + ", PF-minutes: " + parabola_fit_minutes + ", PF-corr: " + parabola_fit_correlation + ", PF-nextDelta: " + parabola_fit_next_delta + ", PF-lastDelta: " + parabola_fit_last_delta +  ", regular Delta: " + glucose_status.delta;
    console.error(calcreason)
    isfreason += "BG Parabolic Fit: nextDelta " + parabola_fit_next_delta + ", lastDelta " +parabola_fit_last_delta + ", regularDelta  " + glucose_status.delta + "; ";
    ...
    if (meal_data.mealCOB>0 && !profile.enableautoisf_with_COB) {
        ...
        if (bg_off > 0) {
            //var delta_ISF = 1;
            console.error("delta_ISF adaptation by-passed as average glucose < " + convert_bg(target_bg, profile) + "+10");
    ...
    if ( sens_modified ) {
        ...
        isfreason += "autoISF -> " + convert_bg(sens,profile) + ", Ratio " +round(liftISF,2)  + "; "

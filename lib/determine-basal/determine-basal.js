...
var isfreason="";  //initialize additional infos for rT.reason
...
// Initialize and calculate variables used for predicting BGs
    ...
    console.error("profile.sens:" + convert_bg(profile.sens,profile) +", sens:" + convert_bg(sens,profile) + ", CSF:" + csf);
    ...
    if (iob_data.iob > max_iob) {
        ...
        if (microBolusAllowed && enableSMB && bg > threshold) {
            ...
            if ( !profile.use_autoisf ) {
                ...
                rT.reason += "SMB Delivery Ratio " + round(smb_ratio,2) + ", ";
              }
            if ( smb_ratio > 0.5) {
                console.error("SMB ratio increased from default 0.5 to " + round(smb_ratio,2))
            }
            ...
            if (bg < max_bg+10) {
                ...
                // lessSMBRatio = round(Math.min(1, 2*(1 - bg/(max_bg+10))), 2);

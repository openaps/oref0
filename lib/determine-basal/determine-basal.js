...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    calcreason = "PF-nDelta: " + parabola_fit_next_delta + ", PF-lDelta: " + parabola_fit_last_delta +  ", regDelta: " + glucose_status.delta + ", ";
    ...
    if ( sens_modified ) {
        ...
        isfreason += calcreason + "autoISF -> " + convert_bg(sens,profile) + ", Ratio " +round(liftISF,2)  + "; "

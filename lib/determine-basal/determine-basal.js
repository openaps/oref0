...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data, currentTime) {
    ...
    // if BG is too old/noisy, or is changing less than 1 mg/dL/5m for 45m, cancel any high temps and shorten any long zero temps
        ...
        if ( glucose_status.last_cal && glucose_status.last_cal < 3 ) {
            ...
            rT.reason = "CGM data is unchanged (+"+glucose_status.delta+") for 5m w/ "+glucose_status.short_avgdelta+" mg/dL ~15m change & "+glucose_status.long_avgdelta+" mg/dL ~45m change";
        }
    }
    ...
    //console.error("Accel. Carb Impact:",aci,"mg/dL per 5m; ACI Duration:",round(aci*5/60*2,1),"hours");

    ...
    if (meal_data.mealCOB>0 && !profile.enableautoisf_with_COB) {
        ...
        if  ( !profile.enable_BG_acceleration){
            ...
            if (minmax_delta < 0 && bg_acce < 0) {
                fitreason = "saw max of " + minmax_value + ", about " + -minmax_delta + " min ago";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta < 0 && bg_acce > 0) {
                fitreason = "saw min of " + minmax_value + ", about " + -minmax_delta + " min ago";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta > 0 && bg_acce < 0) {
                fitreason = "predicts max of " + minmax_value + ", in about " + minmax_delta + "min";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta > 0 && bg_acce > 0) {
                fitreason = "predicts min of " + minmax_value + ", in about " + minmax_delta + " min";
                console.error("Parabolic fit " + fitreason);
            }

...
{   // #### mod 7e: added switch fr autoISF ON/OFF
    if (profile.auto_isf===false) {
      ...
      (typeof profile.autoisf_max === 'undefined') {
        ...
        console.error("autoISF enabled in Preferences, autoISF hourly change: "+profile.autoisf_hourlychange+", max: "+profile.autoisf_max+", SMB Range Extension: "+profile.smb_max_range_extension+", SMB fraction of InsReq: "+profile.smb_delivery_ratio)

    ...
    if (meal_data.mealCOB>0 && !profile.enableautoisf_with_COB) {
        ...
        if  ( !profile.enable_BG_acceleration){
            ...
            if (minmax_delta < 0 && bg_acce < 0) {
                fitreason = "saw maximum of " + minmax_value + ", about " + -minmax_delta + " minutes ago";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta < 0 && bg_acce > 0) {
                fitreason = "saw minimum of " + minmax_value + ", about " + -minmax_delta + " minutes ago";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta > 0 && bg_acce < 0) {
                fitreason = "predicts maximum of " + minmax_value + ", in about " + minmax_delta + "minutes";
                console.error("Parabolic fit " + fitreason);
            } else if (minmax_delta > 0 && bg_acce > 0) {
                fitreason = "predicts minimum of " + minmax_value + ", in about " + minmax_delta + " minutes";
                console.error("Parabolic fit " + fitreason);
            }

...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data) {
    ...
    // duration (hours) = duration (5m) * 5 / 60
    console.error("Carb Impact:",ci,"mg/dL per 5m; CI Duration:",round(cid*5/60,1),"hours");
    console.error("Accel. Carb Impact:",aci,"mg/dL per 5m; ACI Duration:",round(acid*5/60,1),"hours");

...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    isfreason += "BG Parabolic Fit: nextDelta " + convert_bg(parabola_fit_next_delta,profile) + ", lastDelta " +convert_bg(parabola_fit_last_delta,profile) + ", regularDelta  " + convert_bg(glucose_status.delta,profile) + "; ";

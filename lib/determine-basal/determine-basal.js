...
//    var sensitivityRatio;
    ...
    if (sensitivityRatio && profile.enableChris !== true) { // Disable adjustment of basal by sensitivityRatio when using dISF
        ...
        basal = round_basal(basal, profile);
        process.stderr.write("TDD-adjustment of basals activated, using tdd24h_7d_Ratio" + tdd24h_7d_Ratio + ", TDD 24 h = " + tdd + ", Weighted average TDD = " + weightedAverage + ", (Weight percentage = " + weightPercentage + "), 7day average TDD = " + average_7days + ". " );

...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    if (meal_data.mealCOB > 0 && !profile.enableautoisf_with_COB) {
        ...
        isfreason += ", SMB Delivery Ratio:, " + round(smbRatio,2) + ", autoISF"
        ...
        if (bg_ISF < 1) {
            ...
            earlysens = Math.min(720, round(profile.sens / Math.max(profile.autoisf_min, bg_ISF), 1));              // observe ISF maximum of 720?; mod V14j
        ...
        isfreason += ", Duration: " + dura05 + ", Avg: " + convert_bg(avg05,profile) + bgisfreason +  ppisfreason + deltaisfreason + duraisfreason + ", Ratio: " + round(liftISF,2) + ", ISF: " + convert_bg(sens,profile) +  calcreason;

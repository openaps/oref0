...
//var calcreason = ":PF:"; // parabolic fit debugging
...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    console.error(ppdebug + "BG-accel: " + bg_acceleration + ", PF-minutes: " + parabola_fit_minutes + ", PF-corr: " + parabola_fit_correlation + ", PF-nDelta: " + parabola_fit_next_delta + ", PF-lDelta: " + parabola_fit_last_delta +  ", regDelta: " + glucose_status.delta)

...
{   // #### mod 7e: added switch for autoISF ON/OFF
    ...
    calcreason = ", Parabolic Fit:, nextDev " + convert_bg(parabola_fit_next_delta,profile) + " | lastDev " +convert_bg(parabola_fit_last_delta,profile) + " | regDev  " + convert_bg(glucose_status.delta,profile) + ", ";
    ...
    if ( sens_modified ) {
        ...
        isfreason += "autoISF:, ISF " + convert_bg(sens,profile) + ", Ratio " +round(liftISF,2)  + calcreason;
    }
    return sens;
}
...
// Adjust ISF based on sensitivityRatio
    ...
    if (typeof autosens_data !== 'undefined' && autosens_data) {
        ...
        //process.stderr.write(" (autosens ratio "+sensitivityRatio+")");
        isfreason += "Autosense:, ISF "+ convert_bg(profile_sens,profile) +"->" + convert_bg(sens,profile)  + ", Ratio " + sensitivityRatio + ", ";

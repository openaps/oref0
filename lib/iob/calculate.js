...
function iobCalc(treatment, time, curve, dia, peak, profile) {
    ...
    //   activityContrib = amount of treatment.insulin used in last minute
    //   iobContrib = amount of treatment.insulin still remaining at a given point in time
...
function iobCalcBilinear(treatment, minsAgo, dia) {
    ...
    var activityContrib = 0;  // units of insulin used in last minute
    var iobContrib = 0;       // units of insulin still on board

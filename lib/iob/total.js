function iobTotal(opts, time) {
    ...
    treatments.forEach(function(treatment) {
        if(treatment.date <= time.getTime( )) {
            ...
            // tIOB = total IOB
            var tIOB = iobCalc(treatment, time, dia,  profile_data.curve);
            ...
            if (treatment.insulin > profile_data.current_basal/1.5 && treatment.started_at) {
                ...
                // bIOB = bolus IOB
                var bIOB = iobCalc(treatment, time, dia / profile_data.bolussnooze_dia_divisor, profile_data.curve);
                ...
                // aIOB = basal IOB
                var aIOB = iobCalc(treatment, time, dia, profile_data.curve);

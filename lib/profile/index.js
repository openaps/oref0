...
function defaults ( ) {
  return /* profile */ {
   ...
   // , auto_isf: false // enable autoisf code default is false
    ...
    , postmeal_ISF_always: false // Enable the postprandial ISF adaptation all the time regardless of when the last meal was taken.
  };
}
...
function displayedDefaults () {
    ...
    profile.postmeal_ISF_always = allDefaults.postmeal_ISF_always;

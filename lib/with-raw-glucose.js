...
module.exports = function withRawGlucose (entry, cals, raw_safety_multiplier) {
  raw_safety_multiplier = raw_safety_multiplier || 0.75;
  ...
  if (cal && cal.valid) {
    ...
    if (entry.raw && egv < 40 ) {
      entry.glucose = entry.raw * raw_safety_multiplier;
      entry.fromRaw = true;
    }
  }
